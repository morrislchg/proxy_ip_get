 ...
 * FileName: ImagePreProcess3
 * Author:   mixlc
 * Date:     2017/12/27 0027 17:13
 * Description: 验证码识别
 * History:
 * <author>          <time>          <version>          <desc>
 * 作者姓名           修改时间           版本号              描述
 */
package com.mixlc.ip_get.ImageProProgress;
...
public class ImagePreProcess3 {
    ...
    public static void main(String[] args) throws Exception {
        //trainData();
        // downloadImage();
        String text = getAllOcr("C:\\Users\\Administrator\\Desktop\\imgs\\8080\\m_00cdadd4d169acfb.gif");
        System.out.println("m_00cdadd4d169acfb.gif" + text);
